...
from popserver.lib.functional import *
...
class TestRetryDecoraton(TestCase):
    ...
    def test_severalException_success(self):
        fn = retry(10,ZeroDivisionError, AttributeError)(FailUntil(10,ZeroDivisionError))
        self.assertEqual(10, fn(10))

    def test_severalException_failure(self):
        fn = retry(10,ZeroDivisionError, AttributeError)(FailUntil(11,ZeroDivisionError))
        self.assertRaises(ZeroDivisionError, fn, 10)

        fn = retry(10,ZeroDivisionError, AttributeError)(FailUntil(11, AttributeError))
